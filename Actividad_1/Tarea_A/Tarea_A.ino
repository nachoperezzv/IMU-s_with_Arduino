...
void setup() {
  ...
  if(imu.testConnection()){
    ...
    Serial.println("T,RollA,PithA,RollG,PithG");
  }
  else{
...
void calc_ang_giros(){
  ...
  girosc_ang_x = (float)gx*gyroScale*dt/1000.0 + girosc_ang_x_prev;
  girosc_ang_y = (float)gy*gyroScale*dt/1000.0 + girosc_ang_y_prev;
